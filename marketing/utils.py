...
MAILCHIMP_DATA_CENTER = 'us4' #getattr(settings, "MAILCHIMP_DATA_CENTER", None)
...
MAILCHIMP_USER_NAME = getattr(settings, "MAILCHIMP_USER_NAME", None)

if MAILCHIMP_EMAIL_LIST_ID is None:
    raise NotImplementedError("MAILCHIMP_USER_NAME must be set in the settings, Please add your username for mailchimp in settings")
...
class Mailchimp(object):
    ...
    def add_email(self, email):
        ...
        r = requests.post(endpoint, 
                    auth=(MAILCHIMP_USER_NAME, MAILCHIMP_API_KEY), 
    ...
    def code_400_subscription(self, email, status):
        ...
        # endpoint            = "{members_endpoint}/".format(
        #                         members_endpoint=members_endpoint,
        #                         )
        data                = {
                                "email_address": email,
    ...
    def code_400_subscribe(self, email):
        return self.code_400_subscription(email, status='subscribed')
