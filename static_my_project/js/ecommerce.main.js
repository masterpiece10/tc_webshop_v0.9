...
//
//  js Render for stripe
//
var stripeFormModule = $(".stripe-payment-form")
var stripeModuleToken = stripeFormModule.attr("data-token")
var stripeModuleNextUrl = stripeFormModule.attr("data-next-url")
var stripeModuleBtnTitle = stripeFormModule.attr("data-btn-titel") || "Add Card"

var stripeTemplate = $.templates("#stripeTemplate")
var stripeTemplateDataContext = {             // context data must be as passed as {}
    name: "Stripe",
    nextUrl: stripeModuleNextUrl,
    publishableKey: stripeModuleToken,
...
if (paymentForm.length > 1) {
    ...
    form.on('submit', function (event) {
        console.log("start button change")
        event.preventDefault();
        // button display chage if error
        var $this = $(this)
